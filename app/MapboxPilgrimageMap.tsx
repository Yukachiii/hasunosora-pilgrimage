      ...
      if (existingSource) {
        ...
        map.addLayer({
          ...
          layout: {
            ...
            "icon-size": ["interpolate", ["linear"], ["zoom"], 6, 0.045, 10, 0.07, 14, 0.1],
            "icon-anchor": "bottom",
            ...
            "text-size": [
              ...
              ["linear"],
              ["zoom"],
              6, ["case", [">=", ["length", ["get", "indexLabel"]], 3], 5, 6],
              10, ["case", [">=", ["length", ["get", "indexLabel"]], 3], 7, 8],
              14, ["case", [">=", ["length", ["get", "indexLabel"]], 3], 8, 10],
            ],
